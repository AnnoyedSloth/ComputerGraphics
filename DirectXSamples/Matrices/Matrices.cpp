...
HRESULT InitGeometry()
{
    ...
    CUSTOMVERTEX g_Vertices[] =
    {
		...
		{ 0.0f, 0.0f, 3.5f, 0xffff0000, },
		{ 0.0f, 10.0f, 0.0f, 0xffff0000, },
		...
		{ 0.0f, 0.0f, 3.5f, 0xff00ff00, },

		{ -5.0f, 0.0f, 0.0f, 0xff00ff00, },
		{ 0.0f, -10.0f, 0.0f, 0xff00ff00, },
		{ 0.0f, 0.0f, -3.5f, 0xff00ff00, },

		{ 0.0f, 0.0f, 3.5f, 0xff00ffff, },
		{ 0.0f, -10.0f, 0.0f, 0xff00ffff, },
...
VOID SetupMatrices()
{
	...
	D3DXMatrixTranslation(&matWorld2, 10.0f, 0.0f, 0.0f);

	D3DXMatrixMultiply(&matWorld2, &matWorld, &matWorld2);

	D3DXMatrixRotationY(&matWorld3, fAngle);

	D3DXMatrixMultiply(&matWorld3, &matWorld2, &matWorld3);
